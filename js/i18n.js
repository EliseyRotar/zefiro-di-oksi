...
(function (global) {
  ...
  const DICT = {
    it: {
      ...
      'zefir.info': 'Cos\'è la fioristica di zefir? Lo zefir è un dolce delicatissimo originario dell\'Europa dell\'Est. Ha preso il suo nome in onore di Zefiro, l\'antico dio greco del leggero vento d\'occidente, proprio per la sua consistenza leggera e ariosa. Da questa nuvola commestibile nascono petali e fiori. Raccolti a mano, uno per uno, con amore, in piccoli bouquet dolci, da ammirare e poi da gustare. Ogni fiore nasce da purea di frutta fatta in casa, senza <strong>conservanti</strong>, <strong>lattosio</strong> o <strong>glutine</strong>, con <strong>albumina</strong> e <strong>agar-agar</strong>, un\'alternativa naturale alla gelatina adatta anche ai vegetariani. Ho già provato a lavorare con diversi gusti: mela, lampone, ribes nero, pesca, banana, mirtillo di bosco. Presto arriveranno pera, ciliegia, melone e mango: la mia collezione cresce insieme a me. In ogni composizione amo unire fiori di gusti diversi, così ogni bouquet diventa una piccola sorpresa da scoprire.',
    ...
    ru: {
      ...
      'about.title': 'Обо мне',
      'about.body': 'Я - Оксана, но для друзей просто Окси — именно поэтому мой маленький сладкий мир называется «Зефиро ди Окси». Я всегда любила кондитерский мир: начала ещё ребёнком, наблюдая за бабушкой, которая была шеф-поваром в известном ресторане, — и с тех пор не переставала учиться. Я готовила торты, пироженные, печенье, кростаты, круассаны, ароматные французские булочки, чизкейки и шоколадные десерты, освоила зеркальную глазурь и многое другое. А недавно открыла для себя новое увлечение — зефирную флористику: нежнейший десерт, который не имеет ничего общего с маршмэллоу. Я ещё учусь, посещаю курсы зефирной флористики, дипломная работа будет через несколько месяцев. Но мне уже приятно показать вам мои первые небольшие композиции <a href="galleria.html">на странице галереи</a>.',
    ...
    en: {
      ...
      'zefir.info': 'What is zephyr floristry? Zephyr is a delicate dessert originating from Eastern Europe. It got its name in honor of Zephyrus, the ancient Greek god of the gentle west wind, because of its light and airy texture. From this edible cloud, petals and flowers are born. Gathered by hand, one by one, with love, into small sweet bouquets, to be admired and then savored. Every flower is made from homemade fruit purée, free of <strong>preservatives</strong>, <strong>lactose</strong> and <strong>gluten</strong>, with <strong>albumin</strong> and <strong>agar-agar</strong>, a natural alternative to gelatin that\'s also suitable for vegetarians. I\'ve already worked with several flavors: apple, raspberry, blackcurrant, peach, banana, wild cranberry. Pear, cherry, melon and mango are coming soon, my collection keeps growing along with me. In every arrangement I love combining flowers of different flavors, so every bouquet becomes a little surprise waiting to be discovered.',
