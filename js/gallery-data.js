...
(function (global) {
  ...
  */
  const ITEMS = [
    { file: 'gallery-66-zefir-peonie-rosa-crema-scatola-regalo-fiocco-oro.jpg', cat: 'zefir',
      alt: 'Bouquet di peonie di zefir rosa e crema in scatola regalo con fiocco oro',
      order: 1 },
    { file: 'gallery-67-zefir-peonia-crema-tazza-porcellana-fiori.jpg', cat: 'zefir',
      alt: 'Peonia di zefir crema in tazza di porcellana con fiorellini',
      order: 2 },
    { file: 'gallery-68-zefir-peonia-tazza-e-bouquet-cellofan-fiocco.jpg', cat: 'zefir',
      alt: 'Peonia di zefir in tazza e bouquet avvolto in cellofan con fiocco oro',
      order: 3 },
    { file: 'gallery-69-zefir-peonie-rosa-crema-scatola-regalo-aperta.jpg', cat: 'zefir',
      alt: 'Scatola regalo aperta piena di peonie di zefir rosa e crema su tessuto verde',
      order: 4 },
